...
function [groups, kerN] = SpectralClusteringstr(CKSym,n, idx0,opt)
if (nargin < 4)
...
if (~warmstart)
    [groups]  = kmeansstr(kerNS,n,'Start', 'sample', 'maxiter',MAXiter,'replicates',REPlic,'EmptyAction','singleton');
else
